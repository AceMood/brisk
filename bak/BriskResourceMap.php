...
final class BriskResourceMap {
     ...
     * @return {string}
     */
    public function getUriBySymbol($type = BriskConfig::JS, $symbol) {
        $res = $this->getResourceBySymbol($type, $symbol);
        if (isset($res)) {
            return $res[BriskConfig::ATTR_URI];
        } else {
            return '';
        }
    }
     ...
     * @return {string}
     */
    public function getResourceBySymbol($type = BriskConfig::JS, $symbol) {
